...
def designer_forgot_password(request):
    # 1. Security Check: Did they pass the DESIGNER OTP validation?
    ...
    if request.method == "POST":
        ...
        try:
            ...
            if 'temp_email' in request.session:
                del request.session['temp_email']
            if 'can_reset_designer_password' in request.session:
                del request.session['can_reset_designer_password']
    ...
    return render(request, "designer_forgot_password.html")
